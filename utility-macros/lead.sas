...
* Calculate one lead ahead for one variable
...
* History: 15AUG2019 Stu | v0.1 - Initial coding
       10OCT2019 Stu     | v0.2 - Greatly improved performance in some situations by converting from
...
%macro lead(data= /*Input dataset. Supports dataset options.*/
    ...
    data &out.;
      ...
      /* Set last value to missing or a user-specific value for by-groups */
      %if(&by. NE) %then %do;
